...
function PANEL:Init()
	...
	self.DownButton = vgui.Create( "TheDivision_CyclerButton", self );
	self.DownButton:SetTriangleSize( 30 );
	self.DownButton:SetPos( self:GetWide(), 0 );
end;
...
function PANEL:SizeToContents()
	...
	self.DownButton:SetPos( ( padding.l + padding.r ), - ( padding.t + padding.b ) );
	--self:SetWide( 300 );
end;
...
vgui.Register( "TheDivision_Cycler", PANEL );